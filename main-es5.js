(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppComponent = /** @class */ (function () {
                function AppComponent() {
                    ...
                    this.barStroke = function (d) { return d.selected ? 'red' : '#4682b4'; };
                    this.barStrokeWidth = function (d) { return d.selected ? 3 : 1; };
                    this.tooltipContent = function (d) { return d.value + " lb/acre"; };
                    this.mouseOver = function (d, idx, rects) {
                        Object(d3__WEBPACK_IMPORTED_MODULE_2__["select"])(rects[idx]).attr('fill', 'brown');
                    };
                    this.mouseOut = function (d, idx, rects) {
                ...
                AppComponent.prototype.increase = function () {
                    this.data = this.data.map(function (_a) {
                        var year = _a.year, value = _a.value, selected = _a.selected;
                        return ({
                            year: year,
                            value: value + 1,
                            selected: selected
                ...
                AppComponent.prototype.updateSelected = function (selectedYear) {
                    this.year = selectedYear;
                    this.data = this.data.map(function (_a) {
                        var year = _a.year, value = _a.value;
                        return ({
                            year: year,
                            value: value,
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var D3ChartComponent = /** @class */ (function () {
                ...
                D3ChartComponent.prototype.ngOnChanges = function () {
                    if (this.chartProps) {
                        this.updateData();
                    }
                };
                D3ChartComponent.prototype.updateData = function () {
                    {
                        var _a = this, data = _a.data, xAxisProps_1 = _a.xAxisProps, yAxisProps_1 = _a.yAxisProps, marginTop_1 = _a.marginTop, marginBottom_1 = _a.marginBottom, height_1 = _a.height, _b = _a.barStroke, barStroke = _b === void 0 ? '#4682b4' : _b, _c = _a.barStrokeWidth, barStrokeWidth = _c === void 0 ? 1 : _c, _d = _a.barStrokeOpacity, barStrokeOpacity = _d === void 0 ? 0.3 : _d, _e = _a.barFill, barFill = _e === void 0 ? '#4682b4' : _e, _f = _a.barFillOpacity, barFillOpacity = _f === void 0 ? 0.3 : _f, tooltipContent_1 = _a.tooltipContent, mouseOver = _a.mouseOver, mouseOut = _a.mouseOut, click = _a.click;
                        var _g = this.chartProps, g = _g.g, x_1 = _g.x, y_1 = _g.y, xAxisGroup = _g.xAxisGroup, yAxisGroup = _g.yAxisGroup, tooltip_1 = _g.tooltip;
                        x_1.domain(data.map(function (d) { return d[xAxisProps_1.key]; }));
                        y_1.domain([0, Object(d3__WEBPACK_IMPORTED_MODULE_2__["max"])(data, function (d) { return +d[yAxisProps_1.key]; })]);
                        // X Axis
                        var xAxis = Object(d3__WEBPACK_IMPORTED_MODULE_2__["axisBottom"])(x_1);
                        xAxisGroup
                            .call(xAxis)
                            .selectAll('text')
                            .attr('x', -25)
                            ...
                            .attr('fill', xAxisProps_1.textColor || 'currentColor')
                            .attr('fill-opacity', xAxisProps_1.textOpacity || 0.3);
                        xAxisGroup
                            .selectAll('line,path')
                            .style('stroke', xAxisProps_1.stroke || 'currentColor')
                            .attr('stroke-width', xAxisProps_1.strokeWidth || 1);
                        // Y Axis
                        var yAxis = Object(d3__WEBPACK_IMPORTED_MODULE_2__["axisLeft"])(y_1);
                        yAxisGroup
                            .transition()
                            .duration(500)
                            .call(yAxis);
                        yAxisGroup
                            .selectAll('text')
                            .attr('fill', yAxisProps_1.textColor || 'currentColor')
                            .attr('fill-opacity', yAxisProps_1.textOpacity || 0.3);
                        yAxisGroup
                            .selectAll('line,path')
                            .attr('stroke', yAxisProps_1.stroke || 'currentColor')
                            .attr('stroke-width', yAxisProps_1.strokeWidth || 1);
                        // Data join
                        ...
                        bars
                            .enter()
                            .append('rect')
                            .attr('x', function (d) { return x_1(d[xAxisProps_1.key]); })
                            ...
                            if (tooltip_1) {
                                tooltip_1
                                    .html(typeof tooltipContent_1 === 'function' ? tooltipContent_1(d) : tooltipContent_1)
                                    .transition()
                                    .duration(200)
                                    .style('opacity', .9)
                            ...
                            .transition()
                            .duration(500)
                            .attr('y', function (d) { return y_1(+d[yAxisProps_1.key]); })
                            .attr('x', function (d) { return x_1(d[xAxisProps_1.key]); })
                            .attr('width', x_1.bandwidth)
                            .attr('height', function (d) { return (height_1 - marginBottom_1 - marginTop_1) - y_1(d[yAxisProps_1.key]); })
                ...
                D3ChartComponent.prototype.createChart = function () {
                    var _a = this, marginTop = _a.marginTop, marginBottom = _a.marginBottom, marginLeft = _a.marginLeft, marginRight = _a.marginRight, width = _a.width, height = _a.height, xAxisProps = _a.xAxisProps, yAxisProps = _a.yAxisProps, tooltipContent = _a.tooltipContent;
                    var svg = Object(d3__WEBPACK_IMPORTED_MODULE_2__["select"])('svg');
                    var g = svg.append('g')
                    ...
                    var yAxisGroup = g.append('g')
                        .attr('class', 'yAxis');
                    // X Scale
                    var x = Object(d3__WEBPACK_IMPORTED_MODULE_2__["scaleBand"])()
                    ...
                    // Y Scale
                    var y = Object(d3__WEBPACK_IMPORTED_MODULE_2__["scaleLinear"])()
